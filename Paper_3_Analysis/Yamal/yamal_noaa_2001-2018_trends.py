...
plt.savefig('yamal_climatology_bin0_2001-2018.png')

anomalies = lst_semimonth.groupby("bin") - climatology

anomalies.sel(lat=slice(60, 74), lon=slice(65,74), time=slice('2001-05','2001-08')).plot(x="lon", y="lat", col="time", col_wrap=5, vmin=-10, vmax=10);
plt.savefig('anomalies__2001-2018.png')
...
significant_trend.to_netcdf('yamal_significant_trends_2001_2018.nc')