...
# lat=slice(58, 84), lon=slice(-73,-7)
...
anomalies.sel(lat=slice(58, 84), lon=slice(-73,-7), time=slice('2007-05','2007-08')).plot(x="lon", y="lat", col="time", col_wrap=5, vmin=-10, vmax=10);
...
significant_trend.to_netcdf('greenland_significant_trends_2007_2018.nc')